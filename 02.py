...
with tab2:
  ...
  st.title("6.25전쟁")
  st.text('''6.25전쟁은 제2차 세계대전이 끝난직후 미국과 소련의 자유민주주의와 공산주의의 첫 번째 전쟁입니다.
  6.25전쟁에서 기록되고 기록되지 않은 전쟁이 있겠지만 가장 중요한 구국의 3대 전투에 대해 소개해 드리겠습니다.''')
  st.subheader('다부동 전투')         
  st.text('''6.25전투중 가장 치열했던 전투 중 하나로 꼽히는 다부동 전투 이 전투에서
  패배를 하게되면 북의 통일이 되는 상황이기에 가장 중요한 전투이다.또한 다부동 전투를 이끌던
  백선엽 장군의 명언"내가 후퇴하면 나를 쏴라"라는 말을 해 장병둘의 사기를 돋았다.''')
  
  st.subheader('인천상륙작전')
  st.text('''맥아더 장군의 지휘하에 서울 탈환 작전의 밑거름이 되었고, 5000/1의 확률로 성공한 이 작전이 북한군과의
  전세를 뒤바꾸는 중요한 전투였다.또한 이 전투를 통해 38선을 넘어 북진을 하게 만드는 중요한 전투이다.''')
  
  st.subheader('장진호전투')
  st.text('''북에서 펼쳐진 가장 큰 싸움으로 이 전투는 북한군이 한반도 북부로의 진군을 중단시키려는
  시도와 유엔군이 그 진군을 중지시키려는 시도 간의 충돌로 시작되었습니다.유엔군이 중공군에 포위되어 격전을
  벌여 승리하였습니다.이 전투를 기점으로 량걍도 지역까지 진출하는 계기가 되었고 중공군과 북한군에 큰 피해를 입혔습니다.''')
