...
with tab2
  ...
  col1.subheader("6.25전쟁")
  col1.text('''6.25전쟁중 가장 중요한 전투.''')
  col1.text('''다부동 전투
  6.25전투중 가장 치열했던 전투 중 하나로 꼽히는 다부동 전투 이 전투에서
  패배를 하게되면 북의 통일이 되는 상황이기에 가장 중요한 전투이다.또한 
  백선엽 장군의 "내가 후퇴하면 날 쏴라"라는 명언을 남겨 장병들의 사기를 높였다.''')
  col1.text('''인천상륙작전
  ...
  량걍도 지역까지 진출하는 계기가 되었고 중공군과 북한군에 큰 피해를 입힌 전투이다.''')
